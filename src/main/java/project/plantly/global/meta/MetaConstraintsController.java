...
public class MetaConstraintsController {
     ...
     *
     * <p>그 밖에 프론트가 폼을 그리고 막는 근거가 넷 더 있고, 출처가 다르다:
     * <ul>
     ...
     *   <li>이미지 업로드 제약(한 장당 용량·허용 형식)은 요청 DTO 에 없다 — 상한은 설정, 형식은
     *       {@code ImageFormat} enum 이 정본이라 {@code GET /api/v1/meta/upload} 가 따로 준다.</li>
